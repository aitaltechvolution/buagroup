        ...
        <div className="who-grid">
          ...
          <div>
            <FadeUp>
              ...
              <h2 style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontWeight:800, fontSize:"clamp(26px,3.5vw,50px)", color:"var(--text-base)", letterSpacing:"-0.025em", lineHeight:1.1, marginBottom:"22px" }}>
          ...
          <motion.div {...scrollReveal(dir, { axis:"x", distance:36, rotate:2, scale:0.96, delay:0.06, margin:"-60px" })}>
            <div style={{ borderRadius:"20px", overflow:"hidden", aspectRatio:"4/3", boxShadow:"0 32px 72px rgba(0,0,0,0.12)", position:"relative", marginBottom:"18px" }}>
              <div style={{
                ...
                backgroundAttachment:"local", backgroundSize:"cover", backgroundPosition:"center",
              }}>
                <img src="https://buagroup.com/wp-content/uploads/2024/12/BUA-HQ-Drone-Shots-6-edited-1536x1150-1-1024x767.jpg"
                  alt="" onError={()=>setImgErr(true)} style={{opacity:0,position:"absolute",width:1,height:1}} />
              </div>
            ...
            <div className="who-stat-grid">
              {[{val:"11M+ MTPA",label:"Cement Capacity",c:colors.primary},
                ...
                <motion.div key={s.label} whileHover={{y:-3,boxShadow:"0 12px 32px rgba(0,0,0,0.09)"}}
                  ...
                  <div style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:800,fontSize:"clamp(16px,2vw,21px)",color:s.c,letterSpacing:"-0.025em",lineHeight:1,marginBottom:"4px"}}>{s.val}</div>
        ...
        <div className="why-grid">
          {pillars.map((p,i)=>(
            <motion.div key={p.title} {...scrollReveal(dir, { distance:30, rotate:3, scale:0.93, delay:i*0.09, margin:"-40px" })}
              whileHover={{y:-6}} className="glass-dark" style={{padding:"32px 24px",cursor:"default",borderRadius:"16px"}}>
      ...
      <div style={{maxWidth:"1280px",margin:"0 auto"}}>
        <motion.div {...scrollReveal(dir, { distance:32, rotate:1.5, scale:0.97, margin:"-60px" })}
          ...
          style={{
            ...
            borderRadius:"22px", padding:"clamp(32px,5vw,52px) clamp(24px,5vw,56px)",
          ...
          <div className="careers-cta-inner">
            <div style={{position:"relative"}}>
              ...
              <h2 style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:800,fontSize:"clamp(20px,3vw,38px)",color:"#ffffff",letterSpacing:"-0.025em",lineHeight:1.15,marginBottom:"8px"}}>
                Join a dynamic workplace where innovation thrives.
              </h2>
            ...
            <motion.div whileHover={{scale:1.04}} whileTap={{scale:0.97}} style={{position:"relative",flexShrink:0}}>
              <Link to="/careers" className="btn-primary" style={{display:"inline-flex",alignItems:"center",gap:"8px",fontSize:"14px",padding:"15px 32px",whiteSpace:"nowrap"}}>
                Explore Careers
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M2.5 7h9M8 3.5l3.5 3.5L8 10.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
              </Link>
            </motion.div>
